...
export function HomeGallerySlider() {
  ...
  return <section className="home-gallery-slider">
    ...
    <div className="home-gallery-frame"><Image src={current[0]} alt={current[1]} fill sizes="(max-width: 800px) 100vw, 50vw"/><div className="home-gallery-caption"><span>{current[1]}</span><span className="home-gallery-count">{index + 1}/{galleryImages.length}</span></div></div>
